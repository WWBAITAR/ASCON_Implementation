...
HD_PWD='C:/Users/eleves/Documents/Vivado_Design_Suite/ASCON_Implementation/ASCON_Implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ASCON.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ASCON.tcl -notrace
